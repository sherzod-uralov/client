      ...
      <div className="navbar flex items-center justify-between">
        <div className="flex items-center gap-1">
          <div className="flex items-center gap-3">
            <CiMenuBurger
              onClick={ToogleMEnu}
              className="cursor-pointer text-gray-500 lg:hidden block text-[22px] h-8"
            />
          ...
          <ul
            className={`lg:flex-row lg:relative  lg:top-0 lg:bg-transparent lg:border-none flex gap-0 lg:gap-5 bg-gray-50 fixed top-[65px] lg:left-0 ${
              menu ? 'left-[-100%]' : 'left-0'
            } w-full h-full flex-col font-thin lg:font-medium text-[20px] lg:text-[13px]`}
          >
